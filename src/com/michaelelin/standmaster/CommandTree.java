...
import com.michaelelin.standmaster.command.RemoveInvisibleCommand;
...
public class CommandTree {
    ...
    private StandMasterCommand commandBase = new ParentCommand("stand", "Armor stand commands")
        ...
        .addSubcommand(new RemoveInvisibleCommand("removeinvisible", "Remove all invisible armor stands in a specified radius")
